...
function Header() {
  return (
    <>
      <div className="top-0 sticky py-3 backdrop-blur-lg border-b border-neutral-700/80 bg-indigo-950 bg-opacity-50 z-50">
        <div className="px-4 max-auto relative text-sm ">
          <div className="flex justify-center items-center">
                <div className="flex justify-between items-center flex-shrink-0 w-full">
                    <img className="h-10 w-30 mr-40" src={logo}></img>
